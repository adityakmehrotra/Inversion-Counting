...
- You can use the `Makefile` to build the Java file (`inversion_counting.java`) through the compiler and run the algorithm in the Java file (`inversion_counting.java`).
